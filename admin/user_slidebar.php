	              ...
	              <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>">
				   <?php include('count.php'); ?>
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs7"><i class="icon-chevron-right"></i><i class="icon-folder-closed-alt"></i>&nbsp;System log
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs7" class="collapse">						
                            <li class="">
                            <a href="Reports.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> All Devices</a>
                            </li>
							<li class="">
                            <a href="Reports.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Dumped Reports</a>
                            </li>
						    <li class="">
                            <a href="user_log.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Damaged Reports</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						<li class="active">						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Manage system Users
							<div class="muted pull-right"><i class="caret"></i></div></a>						
...
<!-- report -->
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs7"><i class="icon-chevron-right"></i><i class="icon-folder-close-alt"></i>&nbsp;Reports
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs7" class="collapse">						
                            <li class="">
                            <a href="reportall.php"><i class="icon-chevron-right"></i><i class="icon-book"></i> All Devices Reports</a>
                            </li>
							<li class="">
                            <a href="reportdump.php"><i class="icon-chevron-right"></i><i class="icon-trash"></i> Dumped Device Reports</a>
                            </li>
						    <li class="">
                            <a href="reportdamage.php"><i class="icon-chevron-right"></i><i class="icon-fire"></i> Damaged Reports</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* notification sidebar*------->
						...
						<li class="">
				           <a href="schedule.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>&nbsp;Schedule
				           </a>
			            </li>
                         <li class="">
