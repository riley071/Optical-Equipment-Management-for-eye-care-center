        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
                     <div class="row-fluid">					 
					 <h2 id="sc" align="center"><image src="images/sclogo1.png" width="45%" height="45%"/></h2>
				<?php	
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-remove-sign"></i>Generate Report for Dumped Devices</div>
                          <div class="muted pull-right">
								Dumped Device: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
				<h4 id="sc">Generate Report for Dumped Devices
