                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						...
						<li>						
                            ...
                            <li class="">
                            <a href="Reports.php"><i class="icon-chevron-right"></i><i class="icon-book"></i> All Devices Reports</a>
                            </li>
							<li class="">
                            <a href=""><i class="icon-chevron-right"></i><i class="icon-trash"></i> Dumped Device Reports</a>
                            </li>
						    <li class="">
                            <a href="user_log.php"><i class="icon-chevron-right"></i><i class="icon-fire"></i> Damaged Reports</a>
                            </li>
						    </ul>
						</li>
